...
public:
  ...
  void setIgnoreForPoseAdaptation(const LimbEnum &limb,
                                  bool ignorePoseAdaptation);

  const JointPositionsLeg getJointPositionsForLimb(const LimbEnum &limb) const;
  void setJointPositionsForLimb(const LimbEnum &limb,
  ...
  getJointVelocitiesForLimb(const LimbEnum &limb) const;
  void setJointVelocitiesForLimb(const LimbEnum &limb,
  ...
  getJointAccelerationsForLimb(const LimbEnum &limb) const;
  const JointAccelerations &getAllJointAccelerations() const;
  void
  setJointAccelerationsForLimb(const LimbEnum &limb,
  ...
  void setJointEffortsForLimb(const LimbEnum &limb,
  ...
  void setControlSetup(const BranchEnum &branch,
